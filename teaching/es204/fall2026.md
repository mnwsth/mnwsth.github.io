...
| Head TAs (N J Vinay Chandra Singh, Neal Apte Pineda) | TBD |
| Section TAs | TBD |
...
#### Projects (65%) — working hardware + proof of work

Suggested internal split (sums to 65%; may be adjusted):
...
There is **no mandatory attendance percentage** and **no attendance sheets**. Although attendance is not compulsory, students are **expected to attend all tutorials, lectures, and labs**. Contact hours exist so you can build with staff present and complete **milestone demos**.

Credit attaches to **demonstrated progress**, not to being seated in the room. All groups are expected to **carry the designated kits** with them during each of the contact-hour slots. The instructors and core staff **reserve the right to cold-call any group** and check on progress during any lecture, tutorial, or lab session.
