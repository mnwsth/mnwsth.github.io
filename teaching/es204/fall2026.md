...
| Head TA | Vinay | Use staff alias below |
| Head TA | Neal | Use staff alias below |
...
The recommended method for contacting course staff is through the course staff email alias (`es204-staff@googlegroups.com`). We will filter course email through this alias. **Individual emails to course staff will not be answered.**

Use the CAT-SOOP / Google Classroom discussion or help channel for questions that may benefit the whole class.
...
| **Google Classroom** | Course LMS alongside CAT-SOOP (announcements, class organization, and submissions as announced). Classroom link / join code TBD. |
...
The following is a **tentative** guideline and may change. Changes will be announced on CAT-SOOP / Google Classroom and reflected here.
...
- In addition, you will also be required to upload a working video submission for every milestone. One video submission needs to be done from every team, along with a short write-up of the contribution of each team member.
